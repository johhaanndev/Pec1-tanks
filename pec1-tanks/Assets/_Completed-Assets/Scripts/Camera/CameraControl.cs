...
namespace Complete
{
    public class CameraControl : MonoBehaviour
    {
		...
		private void Split() {
            num_players = gameManager.GetCurrentPlayers();
            // Debug.Log("GetCurrentPlayers() = " + gameManager.GetCurrentPlayers());
            if (num_players == 2)
            {
            ...
            // With more than 2 players, screen will be always split in order to avoid mulitple quick screen changes
            else
            {
                splitMode = true;
